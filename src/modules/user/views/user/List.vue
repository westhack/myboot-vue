<template>
  <a-card :bordered="false">
    <search-form-generator
      ...
      @handleSubmit="handleSearch" v-permission:userListquery></search-form-generator>

    <div class="table-operator">
      <a-button type="primary" icon="plus" @click="handleCreate" v-permission:userListadd>新建</a-button>
      ...
      <a-dropdown v-if="selectedRowKeys.length > 0">
        ...
        <a-menu slot="overlay">
          ...
          <a-menu-item key="status_yes" v-permission:userListenable>
          ...
          <a-menu-item key="status_no" v-permission:userListdisable>
      ...
      <span slot="action" slot-scope="text, record">
        ...
        <a-dropdown v-show="record.id !== 1">
          ...
          <a-menu slot="overlay" >
            ...
            <a-menu-item key="status_yes" v-if="record.status == 0" v-permission:userListenable>
              <a-popconfirm title="确定显示?" okText="是" cancelText="否" @confirm="handleTableRowBarAction('status_yes', record)">
                <a-icon type="eye" /> 显示
              </a-popconfirm>
            </a-menu-item>

            <a-menu-item key="status_no" v-if="record.status == 1" v-permission:userListdisable>
...
import { getUserList, userCreate, userUpdate, userDelete } from '@/modules/user/api/user'
